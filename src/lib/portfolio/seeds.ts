...
export const portfolioSeed: PortfolioSnapshot = {
  profile: {
    ...
    headline: "Web, LMS, Dashboard and Mobile App Developer",
    currentRole: "Developer / Digital Product Creator",
    location: "Mizoram, India",
    email: "contact@cjohnmizo.in",
    shortBio:
      "I build practical websites, LMS platforms, dashboards, mobile apps, Firebase tools, Laravel systems, and cleaner UI experiences for real users.",
    longBio:
    ...
    metrics: [
      {
        label: "Core work",
        value: "Web / LMS / dashboards / mobile / Laravel / Firebase",
      },
      {
        label: "Available for",
        value:
  ...
  settings: {
    id: "settings-1",
    heroEyebrow: "cjohnmizo - Mizo Digital Craft",
    heroTitle:
    ...
    heroDescription:
      "Mizo Digital Craft for practical teams: clear interfaces, useful admin workflows, responsive delivery, and reliable handoff.",
    ...
    seoTitle:
      "C. John Remthang | Web, LMS, Dashboard & Mobile App Developer",
    seoDescription:
  ...
  projects: [
    {
      ...
      isFeatured: true,
      isPublished: true,
      coverImage: "/projects/liankhawpui-community-platform.svg",
      galleryImages: ["/projects/liankhawpui-community-platform.svg"],
      demoUrl: null,
    ...
    },
    {
      ...
      isFeatured: true,
      isPublished: true,
      coverImage: "/projects/tz-coaching-lms.svg",
      galleryImages: ["/projects/tz-coaching-lms.svg"],
    ...
    },
    {
      ...
      isFeatured: true,
      isPublished: true,
      coverImage: "/projects/gaby-farm.svg",
      galleryImages: ["/projects/gaby-farm.svg"],
      demoUrl: null,
      githubUrl: null,
      caseStudyUrl: null,
    ...
    },
    {
      ...
      isFeatured: true,
      isPublished: true,
      coverImage: "/projects/smart-modern-admin-dashboard.svg",
      galleryImages: ["/projects/smart-modern-admin-dashboard.svg"],
    ...
    },
    {
      ...
      isFeatured: true,
      isPublished: true,
      coverImage: "/projects/tualchher-cms-dashboard.svg",
      galleryImages: ["/projects/tualchher-cms-dashboard.svg"],
      demoUrl: null,
    ...
    },
    {
      ...
      isFeatured: false,
      isPublished: true,
      coverImage: "/projects/library-lms-tools.svg",
      galleryImages: ["/projects/library-lms-tools.svg"],
      demoUrl: null,
      githubUrl: null,
      caseStudyUrl: null,
