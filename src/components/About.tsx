...
const About = () => {
    return (
        <section id="about" className="py-16 sm:py-24 md:py-32 relative bg-[var(--bg-secondary)] overflow-hidden">
            {/* Ambient orbs */}
            <div className="absolute top-1/4 left-0 w-[300px] h-[300px] bg-[var(--accent)] rounded-full blur-[150px] opacity-[0.04]" />
            <div className="absolute bottom-0 right-0 w-[250px] h-[250px] bg-[var(--accent-secondary)] rounded-full blur-[120px] opacity-[0.03]" />
